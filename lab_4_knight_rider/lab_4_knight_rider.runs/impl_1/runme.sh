...
HD_PWD='D:/vivado/Projects/lab_4_knight_rider/lab_4_knight_rider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Knight_Rider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_Knight_Rider.tcl -notrace
