...
HD_PWD='D:/vivado/Projects/lab_4_knight_rider/lab_4_knight_rider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Knight_Rider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_Knight_Rider.tcl
