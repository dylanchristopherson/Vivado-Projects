...
HD_PWD='D:/vivado/Projects/lab_8/lab_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pixels.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pixels.tcl
