...
HD_PWD='D:/vivado/Projects/lab_8/lab_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pixels.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pixels.tcl -notrace
