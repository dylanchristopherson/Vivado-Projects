...
HD_PWD='D:/vivado/Projects/lab_12_servo_motor/lab_12_servo_motor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servoPWM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servoPWM.tcl
