...
HD_PWD='D:/vivado/Projects/lab_12_servo_motor/lab_12_servo_motor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servoPWM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servoPWM.tcl -notrace
