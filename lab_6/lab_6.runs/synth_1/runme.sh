...
HD_PWD='D:/vivado/Projects/lab_6/lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_light_top.tcl
