...
HD_PWD='D:/vivado/Projects/lab_6/lab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_light_top.tcl -notrace
