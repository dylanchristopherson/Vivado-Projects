...
HD_PWD='D:/vivado/Projects/lab_7_keypad/lab_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodKeypad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodKeypad.tcl
