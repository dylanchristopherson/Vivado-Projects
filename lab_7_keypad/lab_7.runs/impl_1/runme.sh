...
HD_PWD='D:/vivado/Projects/lab_7_keypad/lab_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodKeypad.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodKeypad.tcl -notrace
