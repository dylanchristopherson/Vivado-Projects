...
HD_PWD='D:/vivado/Projects/lab_10/lab_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_leds.tcl
