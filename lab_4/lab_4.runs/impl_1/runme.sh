...
HD_PWD='D:/vivado/Projects/lab_4/lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UpCounter99.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UpCounter99.tcl -notrace
