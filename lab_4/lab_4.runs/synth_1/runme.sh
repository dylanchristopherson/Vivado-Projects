...
HD_PWD='D:/vivado/Projects/lab_4/lab_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UpCounter99.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UpCounter99.tcl
