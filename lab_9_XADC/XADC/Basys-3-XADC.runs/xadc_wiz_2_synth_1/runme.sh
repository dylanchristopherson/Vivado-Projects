...
HD_PWD='D:/vivado/Projects/lab_9_XADC/XADC/Basys-3-XADC.runs/xadc_wiz_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_wiz_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_wiz_2.tcl
