...
HD_PWD='D:/vivado/Projects/lab_3_single_digit_upcounter/lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log double_digit_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source double_digit_counter.tcl -notrace
