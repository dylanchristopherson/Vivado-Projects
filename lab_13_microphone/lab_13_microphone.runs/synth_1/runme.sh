...
HD_PWD='D:/vivado/Projects/lab_13_microphone/lab_13_microphone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_volume_meter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_volume_meter.tcl
