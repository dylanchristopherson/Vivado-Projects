...
HD_PWD='D:/vivado/Projects/lab_13_microphone/lab_13_microphone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_volume_meter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_volume_meter.tcl -notrace
