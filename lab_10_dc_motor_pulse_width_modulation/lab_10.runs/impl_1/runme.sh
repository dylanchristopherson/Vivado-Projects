...
HD_PWD='D:/vivado/Projects/lab_10/lab_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_leds.tcl -notrace
