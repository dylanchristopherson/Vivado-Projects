...
HD_PWD='D:/vivado/Projects/Security_System/Security_System.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodKeypad_SS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodKeypad_SS.tcl -notrace
