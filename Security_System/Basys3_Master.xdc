...
# Switches
#set_property PACKAGE_PIN V17 [get_ports { breakkk }]					
#	set_property IOSTANDARD LVCMOS33 [get_ports { breakkk }]
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports off_or_on ]					
	set_property IOSTANDARD LVCMOS33 [get_ports off_or_on ]
set_property PACKAGE_PIN E19 [get_ports LED ]					
	set_property IOSTANDARD LVCMOS33 [get_ports LED ]
#set_property PACKAGE_PIN U19 [get_ports {LEDS[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {LEDS[0]}]
#set_property PACKAGE_PIN V19 [get_ports {LEDS[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {LEDS[1]}]
#set_property PACKAGE_PIN W18 [get_ports {LEDS[2]}]					
...
#set_property PACKAGE_PIN V3 [get_ports {LEDS[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {LEDS[7]}]
#set_property PACKAGE_PIN W3 [get_ports LEDM ]					
...
set_property PACKAGE_PIN V7 [get_ports pointer]							
	set_property IOSTANDARD LVCMOS33 [get_ports pointer]
...
##btnUP
#set_property PACKAGE_PIN T18 [get_ports breakkk]						
#	set_property IOSTANDARD LVCMOS33 [get_ports breakkk]
##btnL
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports breakkk]					
#	set_property IOSTANDARD LVCMOS33 [get_ports breakkk]
##Sch name = JB2
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports break]					
