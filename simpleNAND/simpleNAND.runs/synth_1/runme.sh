...
HD_PWD='D:/vivado/Projects/simpleNAND/simpleNAND.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleNAND.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simpleNAND.tcl
