...
HD_PWD='D:/vivado/Projects/simpleNAND/simpleNAND.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleNAND.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simpleNAND.tcl -notrace
