...
HD_PWD='D:/vivado/Projects/homework_1/homework_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log homework_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source homework_1.tcl -notrace
