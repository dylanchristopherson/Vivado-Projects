...
HD_PWD='D:/vivado/Projects/homework_1/homework_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log homework_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source homework_1.tcl
